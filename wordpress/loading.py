...
class WPAPILoader(object):
    ...
    def load_site(self, purge_first=False, full=False, modified_after=None, type=None):
        """
        ...
        if type == "all":
            for post_type in ["attachment", "post", "page"]:
                self.load_posts(post_type=post_type)
        elif type in ["attachment", "post", "page"]:
            self.load_posts(post_type=type)
    ...
    def load_posts(self, post_type=None, max_pages=200):
        """
        ...
        self.set_posts_param_modified_after(params, post_type)
    ...
    def set_posts_param_modified_after(self, params, post_type):
        """
